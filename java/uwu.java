...
//            System.out.println("?) Eliminar producto de carrito");
    ...
    public void cerdoFresco() {
        int tumi222;
        do {
            System.out.println("1) Chuleta de lomo");
            System.out.println("2) Chuleta de brazuelo");
            System.out.println("3) Costillita St Louis");
    ...
    public void cerdoCongelado() {
        int fernando;
        do {
            System.out.println("1) Pernil de cerdo congelado");
            System.out.println("2) Pierna de cerdo congelada");
            System.out.println("3) Brazuelo de cerdo congelado");
            System.out.println("0) Salir");
            System.out.println("Ingresar una opcion: ");
    ...
    public void Huevo() {
        int tumi;
        do {
            System.out.println("Menu de huevo");
